...
Different event scale selections were investigated by selecting events that include a hard jet or a high-$\pt$ leading particle in mid-rapidity (i.e., the highest reconstructed $\pt$ inside the acceptance region in an event).
